...
print("  1. [udpreceive 8998] - Receiving UDP on correct port")
print("  2. Connect to [print] to see if ANY data is received")
print("  3. If receiving data, connect to OSC parsing objects:")
print("     [udpreceive 8998] → [print]")
print("     [udpreceive 8998] → [OSC-route voice_ active_count]")

print("\n🐛 COMMON ISSUES & SOLUTIONS:")
print("  ISSUE: No data received at all")
print("  ✓ Check port 8998 is correct in MaxMSP")
...
print("  3. In MaxMSP, temporarily connect [udpreceive 8998] to [print]")
...
print("  📤 SENDING 3 OSC MESSAGES TO MAXMSP (Port 8998):")
...
print("  2. In MaxMSP: [udpreceive 8998] → [print]")
